...
<body>
	<div class="login-box">
		제목 : ${WriteFb.fb_req_title}
		<br> <br> 
		피드백 요청자 :
		${WriteFb.fb_req_id} <br> <br> 요청자 소환사명 : ${WriteFb.fb_req_summonerName} <br>
		<br> 요청자 받고자하는 게임 : <button class="grOneGameList" data-code="${WriteFb.fb_req_gameId}" type = "button"> 게임 정보 보기</button> <br> <br>
		요청 날짜 : ${WriteFb.fb_req_date} <br> <br>
		<br>
		...
		<table class="content-from">
			<tr>
				...
				<td ><textarea name="fb_ans_contents"
						id="fb_ans_contents" cols="80" rows="20" placeholder="내용"
