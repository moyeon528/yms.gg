		...
		<div class="content">
			...
			<div class="login-box" id = "bbList">
				<table class="rwd-table">
					...
					<c:forEach var="board" items="${bbList}">
						<tr height="25">
							<td align="center">${board.bb_postNum}
								<button class="bbDelete" data-code="${board.bb_postNum}">게시글
									삭제</button>
							</td>
							<td align="center"><a href="#"
								onclick="articleView(${board.bb_postNum})">${board.bb_title}</a></td>
							<td align="center">${board.bb_id}</td>
