			...
			<div class="login-box">
				<div class="user-box">
					<c:forEach var="member" items="${memberInfo}">
						...
						<input type="text" name="m_id" id="m_id" value="${member.m_id}">
						<input type="text" name="m_summonerName"
							value="${member.m_summonerName}">
						<input type="text" name="m_creationDate"
							value="${member.m_creationDate}">
						<button class="Mdelete" data-code="${member.m_id}">회원 삭제</button>
